...
Dataset: open source image datasets would be used for training - project would create new datasets through inference on workshop usage. We have Oak 1 and Oak D cameras available for implementation.
